...
'''
reference: https://github.com/ShangtongZhang/DeepRL/blob/master/deep_rl/agent/DDPG_agent.py
things that are unecessary have been commented out on 2019-11-04
'''
